...
Bem-vindo ao meu repositório GitHub dedicado à minha jornada como **Cientista de Dados / Analista de Dados**. Aqui, reúno todos os meus projetos de aprendizado, desafios analíticos e cases reais desenvolvidos ao longo da minha formação na **EBAC (British School of Art and Technology)** e processos seletivos como o da **Indicium Lighthouse**.
...
Este repositório ajuda a organizar e apresentar minha evolução em ciência de dados, facilitando a exploração dos scripts, notebooks, previsões, dashboards e raciocínio analítico.
...
Projeto de machine learning focado em prever notas do IMDB com base em informações de produção, orçamento, elenco, gênero e metadados categóricos. Inclui análise exploratória, engenharia de atributos, treino de modelos, tuning e avaliação de performance.
...
Projetos desenvolvidos no curso de Ciência de Dados da EBAC, cobrindo os fundamentos da jornada de dados:
